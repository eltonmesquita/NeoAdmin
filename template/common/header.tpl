  ...
  <div class="large-1 columns" id="menu-left">
    <nav>
      <ul class="left">
        ...
        <li class="has-flyout" id="catalog"><a class="top"><i class="icon-file-2"></i></br><?php echo $text_catalog; ?></a>
          <ul class="flyout">
            <li><a href="<?php echo $category; ?>"><?php echo $text_category; ?></a></li>
            <li><a href="<?php echo $product; ?>"><?php echo $text_product; ?></a></li>
            <li><a href="<?php echo $filter; ?>"><?php echo $text_filter; ?></a></li>
            <li class="has-flyout"><a class="parent"><?php echo $text_attribute; ?></a>
              <ul class="flyout">
        ...
        <li class="has-flyout" id="sale"><a class="top"><i class="icon-coin"></i></br><?php echo $text_sale; ?></a>
          <ul class="flyout">
        ...
        <li class="has-flyout" id="help"><a class="top last-menu"><i class="icon-question-sign"></i></br><?php echo $text_help; ?></a>
          <ul class="flyout">
          ...
          <aside>
            <ul class="right">
              ...
              <li id="store"><a href="<?php echo $store; ?>" target="_blank" class="top"><i class="icon-link"></i>&nbsp;<?php echo $text_front; ?></a>
               ...
               <li><a class="top" href="<?php echo $logout; ?>"><i class="icon-cross"></i>&nbsp;<?php echo $text_logout; ?></a></li>
            </ul>
          </aside>
        </div>
      </div>
