...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a href="<?php echo $invoice; ?>" target="_blank" class="button"><?php echo $button_invoice; ?></a><a href="<?php echo $cancel; ?>" class="button cancel"><i class="icon-cross"></i>&nbsp;<?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
