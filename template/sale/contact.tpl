...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a id="button-send" onclick="send('index.php?route=sale/contact/send&token=<?php echo $token; ?>');" class="button"><?php echo $button_send; ?></a><a href="<?php echo $cancel; ?>" class="button cancel"><i class="icon-cross"></i>&nbsp;<?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
